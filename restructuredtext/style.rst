...
See the pages on :doc:`writing documentation for packages </stack/package-docs>` and :doc:`Python docstrings </python/numpydoc>` for specific reST usage in those contexts.

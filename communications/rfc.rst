...
If a RFC includes API changes, including deprecations, or updates to a data model, like for example the catalog schema generated by the DRP, it must be approved by the DMCCB.

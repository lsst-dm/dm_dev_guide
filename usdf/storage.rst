...
Personal space:
 ...
 - Rubin-allocated space: /sdf/group/rubin/user/<account_name> with a 1 TB quota (a symlink to this directory, called rubin-user, is auto-created in your home directory). If you need more space, request it in #ops-usdf, and a ticket will get opened to request the quota increase.
